        ...
        switch ($choice) {
            "1" {
                ...
                while ($refreshStats) {
                    ...
                    Write-Host "            (Press R to refresh, any key to exit)" -ForegroundColor Gray
                    Write-Host "=============================================================" -ForegroundColor Cyan
                    Write-Host ""
                    ...
                    Write-Host ""
                    Write-Host "Press R to refresh, any other key to exit..." -ForegroundColor Gray
                    $key = $Host.UI.RawUI.ReadKey("NoEcho,IncludeKeyDown")
                    if ($key.Character -ne "r" -and $key.Character -ne "R") {
                        $refreshStats = $false
                    }
                }
